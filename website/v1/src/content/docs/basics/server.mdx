...
If you generated your project with `prettynice init`, it will look like this:
...
This is where you define the host and port that server will listen on:
...
This makes it useful for pattern matching.
TODO: add array pattern matching to gren book.

THEN: You can also pattern match on...
