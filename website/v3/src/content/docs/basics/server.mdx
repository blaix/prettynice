...
For a more complex program, we might need to
[initialize some subsystems](https://packages.gren-lang.org/package/gren-lang/node/version/5/module/Init)
here and save subsystem permissions to our model so they can be used in the router.
