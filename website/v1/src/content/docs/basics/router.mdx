...
See [the pattern matching section](https://gren-lang.org/book/syntax/pattern_matching/) of the gren book for more information on gren's pattern matching capabilities.

TODO: Add arrays to the pattern matching section of the gren book.

TODO: then finish this section.
