...
For the homepage, we're using [Response.sendHtml](https://packages.gren-lang.org/package/blaix/prettynice/version/1.0.2/module/Prettynice.Response#sendHtml)
to render HTML:
...
<Aside>
    Prettynice expects [Transmutable.Html](https://packages.gren-lang.org/package/icidasset/html-gren/version/4.1.0/module/Transmutable.Html),
    which has the same API as the normal [Html from the browser package](https://packages.gren-lang.org/package/gren-lang/browser/version/3.2.0/module/Html),
